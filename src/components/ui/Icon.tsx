...
export type IconName =
  | 'search' | 'arrow' | 'arrowDownRight' | 'chevron' | 'chevronDown'
  | 'check' | 'close' | 'copy' | 'external' | 'play' | 'wallet' | 'code'
  | 'book' | 'discord' | 'github' | 'twitter' | 'domain' | 'server'
  | 'legal' | 'mail' | 'bolt' | 'spark' | 'grid' | 'list' | 'dollar'
  | 'activity' | 'box' | 'shield' | 'user' | 'layers' | 'file' | 'expand'
  | 'refresh' | 'pkg' | 'plug' | 'diff';
...
const PATHS: Record<IconName, JSX.Element> = {
  ...
  discord: <><path d="M5 7c4-2 10-2 14 0M5 17c4 2 10 2 14 0"/><path d="M5 7c-1 4-1 6 0 10M19 7c1 4 1 6 0 10"/><circle cx="9.5" cy="12" r="1"/><circle cx="14.5" cy="12" r="1"/></>,
  ...
  pkg: <><path d="m21 8-9-5-9 5 9 5z"/><path d="M3 8v8l9 5 9-5V8"/><path d="M12 13v9"/></>,
  plug: <><path d="M9 2v6M15 2v6M6 8h12v4a6 6 0 0 1-12 0z"/><path d="M12 18v4"/></>,
  diff: <path d="M12 3v18M3 8l9 4 9-4"/>,
};
